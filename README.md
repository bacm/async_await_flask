...
Quart a une API quasi-identique à Flask. La migration est simple!
...
| DB queries | Synchrone | `await` nécessaire |
| Sleep | `time.sleep()` | `await asyncio.sleep()` |
| File I/O | `open()` | `await aiofiles.open()` |
